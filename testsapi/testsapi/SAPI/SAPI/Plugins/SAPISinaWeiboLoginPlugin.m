...
#import "SAPISinaWeiboLoginPlugin.h"
#import "SAPIHudHelper.h"
#import "SAPIImageDef.h"

@implementation SAPISinaWeiboLoginPlugin

@synthesize loginViewController = _loginViewController;

- (void)action_social_sina_weibo_webview:(SAPIInvokeCommand *)command {
    NSURL *url = [NSURL URLWithString:[[SAPIMainManager sharedManager] sinaLoginUrl]];
    SAPISinaWeiboLoginViewController *renrenLoginViewController = [[SAPISinaWeiboLoginViewController alloc] initWithURL:url];
...
@interface SAPISinaWeiboLoginViewController () <SAPIMainWebViewDelegate>
...
@implementation SAPISinaWeiboLoginViewController
...
- (void)createNavBar {
	...
	UINavigationItem *NavTitle = [[UINavigationItem alloc] initWithTitle:@"新浪微博登录"];
