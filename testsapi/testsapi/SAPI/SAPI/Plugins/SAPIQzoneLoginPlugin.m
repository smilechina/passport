...
#import "SAPIQzoneLoginPlugin.h"
#import "SAPILib.h"
#import "SAPIHudHelper.h"
#import "SAPIImageDef.h"

@implementation SAPIQzoneLoginPlugin

@synthesize loginViewController = _loginViewController;

- (void)action_social_qzone_webview:(SAPIInvokeCommand *)command {
    NSURL *url = [NSURL URLWithString:[[SAPIMainManager sharedManager] qqLoginUrl]];
    SAPIQzoneLoginViewController *qzoneLoginViewController = [[SAPIQzoneLoginViewController alloc] initWithURL:url];
...
@interface SAPIQzoneLoginViewController () <SAPIMainWebViewDelegate>
...
@implementation SAPIQzoneLoginViewController
...
- (void)createNavBar {
	...
	UINavigationItem *NavTitle = [[UINavigationItem alloc] initWithTitle:@"腾讯QQ登录"];
